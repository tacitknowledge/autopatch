...
<ol>
  ...
  <li>Create a sourceforge.net account, and use it to sign up to the <a href="https://lists.sourceforge.net/lists/listinfo/autopatch-cvs">autopatch-cvs</a> mailing list so you can see what other people are working on
