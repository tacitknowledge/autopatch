...
namespace com.tacitknowledge.util.migration.ado
{
	...
	/// failonerror="true" 
	/// classname="com.tacitknowledge.util.migration.ado.StandaloneMigrationLauncher"&gt;
	...
	public class StandaloneMigrationLauncher
	{
		...
		//UPGRADE_NOTE: The initialization of  'log' was moved to static method 'com.tacitknowledge.util.migration.ado.StandaloneMigrationLauncher'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		static StandaloneMigrationLauncher()
		{
			log = LogManager.GetLogger(typeof(StandaloneMigrationLauncher));
		}
	}
}